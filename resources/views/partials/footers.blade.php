    <!-- Footer Start -->
    <footer class="dark:bg-slate-900 pt-24 pb-12 k">
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full px-4 mb-12 text-slate-500 dark:text-slate-300 font-medium md:w-1/3">
                    <h2 class="font-bold text-3xl text-black dark:text-white mb-5">Hamz</h2>
                    <h3 class="font-bold text-xl mb-2">Hubungi Saya</h3>
                    <p>+62 896-5859-1537</p>
                    <p>ilhamputra0601@gmail.com</p>
                    <p>Jl. Margonda Raya Stangkle Rt. 05/16 No.25 </p>
                    <p>Beji | Depok</p>
                </div>
                <div class="w-full px-4 mb-12 md:w-1/3">
                    <h3 class="font-semibold text-lg text-black dark:text-white mb-5">Kategori Tulisan</h3>
                    <ul class="text-slate-500 dark:text-slate-300">
                        <li>
                        ...
                        <li>
                            <a href="#" class="inline-block text-base hover:text-primary mb-3">3D Design</a>
                        </li>
                    </ul>
                </div>
                <div class="w-full px-4 mb-12 md:w-1/3">
                    <h3 class="font-semibold text-lg text-black dark:text-white mb-5">Tautan</h3>
                    <ul class="text-slate-500 dark:text-slate-300">
                        <li>
            ...
            <div class="w-ful pt-10 border-t border-slate-700">
                ...
                <p class="font-medium text-xs text-slate-500 text-center">©️ Created by <a target="_blank" href="https://Instagram.com/il.pra" class="font-bold text-primary2 ">Ilham Ramadhan</a>, using <a target="_blank" href="https://tailwindcss.com" class="font-bold text-sky-500 ">Tailwind CSS </a> dan <a target="_blank" href="https://laravel.com" class="font-bold text-red-600 ">Laravel </a>2023.</p>
            </div>
        </div>
    </footer>
    <!-- Footer End -->
